<template>
  <b-container>
    ...
    <p>With 1 thread:</p>
    <Results :input="transactions1Thread" :key="reloadTrigger"></Results>
    <p>With 20 threads:</p>
    <Results :input="transactions20Threads" :key="reloadTrigger"></Results>
    ...
    <p>Each transaction is doing one KV read. It should have near-identical performance to non-transactional KV
      gets.</p>
    <p>With 1 thread:</p>
    <Results :input="transactionsReadOnly1Thread" :key="reloadTrigger"></Results>
    <p>With 20 threads:</p>
    <Results :input="transactionsReadOnly20Threads" :key="reloadTrigger"></Results>
  </b-container>
</template>
